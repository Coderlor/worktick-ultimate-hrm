...
<div class="breadcrumb">
    <h1>{{ __('translate.Training_List') }}</h1>
    <ul>
        <li><a href="/trainings">{{ __('translate.Trainings') }}</a></li>
        <li>{{ __('translate.Training_List') }}</li>
    </ul>
</div>

<div class="separator-breadcrumb border-top"></div>

<div class="row" id="section_Training_list">
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-header text-right bg-transparent">
                @can('training_add')
                <a class="btn btn-primary btn-md m-1" href="{{route('trainings.create')}}"><i
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="training_list_table" class="display table">
                        <thead>
                            <tr>
                                <th></th>
                                <th>#</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td @click="selected_row( {{ $training->id}})"></td>
            ...
            delete_selected() {
                ...
                swal({
                    ...
                    buttonsStyling: false
                        ...
                        axios
                        .post("/trainings/delete/by_selection", {
