...
<div class="breadcrumb">
    <h1>{{ __('translate.Edit_Task') }}</h1>
    <ul>
        <li><a href="/tasks">{{ __('translate.Tasks') }}</a></li>
        <li>{{ __('translate.Edit_Task') }}</li>
    </ul>
</div>
...
<!-- begin::main-row -->
<div class="row" id="section_Task_Edit">
    <div class="col-lg-12 mb-3">
        <div class="card">

            <!--begin::form-->
            <form @submit.prevent="Update_Task()">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
