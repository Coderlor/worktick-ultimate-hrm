...
<div class="breadcrumb">
    ...
    <ul>
        <li><a href="/accounting/deposit">{{ __('translate.Deposit') }}</a></li>
        <li>{{ __('translate.Deposit_List') }}</li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-header text-right bg-transparent">
                @can('deposit_add')
                <a class="btn btn-primary btn-md m-1" href="{{route('deposit.create')}}"><i
            ...
            delete_selected() {
                ...
                swal({
                    ...
                    buttonsStyling: false
                        ...
                        axios
                        .post("/accounting/deposit/delete/by_selection", {
