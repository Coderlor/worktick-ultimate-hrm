...
<div class="breadcrumb">
    ...
    <ul>
        <li><a href="/client_profile">{{ __('translate.Profile') }}</a></li>
...
<div class="card user-profile o-hidden mb-4" id="section_Client_Profile_list">
    ...
    <div class="card-body">
        <form @submit.prevent="Update_Profile()" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
                    <label for="FirstName" class="ul-form__label">{{ __('translate.First_Name') }} <span
                            class="field_required">*</span></label>
                    <input type="text" v-model="user.firstname" class="form-control" name="FirstName" id="FirstName"
                        placeholder="{{ __('translate.Enter_First_Name') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" v-model="user.lastname" class="form-control" id="lastname" id="lastname"
                        placeholder="{{ __('translate.Enter_Last_Name') }}">
...
<script>
    var app = new Vue({
        el: '#section_Client_Profile_list',
        data: {
            data: new FormData(),
        ...
        methods: {
           ...
           Update_Profile() {
                ...
                self.data.append("city", self.user.city);
                ...
                axios
                    .post("/client_profile/" + self.user.id, self.data)
                    .then(response => {
